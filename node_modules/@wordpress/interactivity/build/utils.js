...
function withScope(func) {
  const scope = (0, _scopes.getScope)();
  const ns = (0, _namespaces.getNamespace)();
...
function useCallback(callback, inputs) {
  return (0, _hooks.useCallback)(withScope(callback), inputs);
}
...
function useMemo(factory, inputs) {
  return (0, _hooks.useMemo)(withScope(factory), inputs);
}
